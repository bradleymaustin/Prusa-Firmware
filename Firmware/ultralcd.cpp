...
void lcd_generic_preheat_menu()
{
    ...
    else
    {
        ...
        MENU_ITEM_SUBMENU_P(bPreheatOnlyNozzle ? PSTR("NYLONG  -  " STRINGIFY(NYLONG_PREHEAT_HOTEND_TEMP)) : PSTR("NYLONG  -  " STRINGIFY(NYLONG_PREHEAT_HOTEND_TEMP)  "/" STRINGIFY(NYLONG_PREHEAT_HPB_TEMP)) , mFilamentItem_NYLONG);
